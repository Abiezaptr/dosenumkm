                        ...
                        <div class="chatting-box d-block">
                            <div class="p-9 border-bottom chat-meta-user d-flex align-items-center justify-content-between">
                                <div class="hstack gap-3 current-chat-user-name">
                                    ...
                                    <div class="">
                                        <h6 class="mb-1 name fw-semibold">Andrew</h6>
                                        <p class="mb-0"><span class="text-muted"><small>#K09JTRK</small></span></p>
                                    </div>
                                </div>
                            ...
                            <div class="position-relative overflow-hidden d-flex">
                                <div class="position-relative d-flex flex-grow-1 flex-column">
                                    <div class="chat-box p-9" style="height: calc(150vh - 442px)" data-simplebar>
                                        <div class="chat-list chat active-chat" data-user-id="1">

                                            <div class="hstack gap-3 align-items-start mb-7 justify-content-end">
                                                <div class="text-end">
                                                    <h6 class="fs-2 text-muted">21:27</h6>
                                                    <div class="p-2 bg-light-info text-dark rounded-1 d-inline-block fs-3"> Tertarik dengan paket : Perbaikan Error </div>
                                                </div>
                                            </div>
                                            <div class="hstack gap-3 align-items-start mb-7 justify-content-start">
                                                <img src="<?= base_url('dist') ?>/images/profile/user-8.jpg" alt="user8" width="40" height="40" class="rounded-circle" />
                                                <div>
                                                    <h6 class="fs-2 text-muted">21:27</h6>
                                                    <div class="p-2 bg-light rounded-1 d-inline-block text-dark fs-3"> [Pesan Otomatis dari Konsultan]<br>Halo, ada yang bisa di bantu?</div>
                                                </div>
                                            </div>
                                            <div class="hstack gap-3 align-items-start mb-7 justify-content-end">
                                                <div class="text-end">
                                                    <h6 class="fs-2 text-muted">21:28</h6>
                                                    <div class="p-2 bg-light-info text-dark mb-1 d-inline-block rounded-1  fs-3"> Saya tertarik untuk menghubungi anda </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="app-chat-offcanvas border-start" style="height: calc(150vh - 380px)" data-simplebar="">
                                    <div class="p-3 d-flex align-items-center justify-content-between">
                                        <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#vertical-center-modal">Lihat cara untuk mempekerjakan</button>
                                    </div>
                                    <div class="offcanvas-body p-4">
                                                ...
                                                <div class="col-12 px-1">
                                                    <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between mb-9">
                                                        <div class="d-flex align-items-center gap-3">
                                                            <img src="<?= base_url('dist') ?>/images/web.jpg" alt="" width="50" height="50">
                                                            <div>
                                                                <h6 class="fw-semibold">Membuat Website Toko Online dengan Codeigniter</h6>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
                                        ...
                                        <div class="files-chat">
                                            ...
                                            <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between mb-9">
                                                <div class="d-flex align-items-center gap-3">
                                                    <div>
                                                        <h6 class="fw-light">Kode Order : K09JTRK</h6>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                            ...
                                            <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between mb-9">
                                                <div class="d-flex align-items-center gap-3">
                                                    <div class="rounded-1 bg-light p-6">
                                                        <img src="<?= base_url('dist') ?>/images/chat/icon-adobe.svg" alt="" width="24" height="24">
                                                    </div>
                                                    <div>
                                                        <h6 class="fw-semibold">Profile Company.pdf</h6>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <ul class="timeline-widget mb-0 position-relative mb-n5">
                                    ...
                                    <li class="timeline-item d-flex position-relative overflow-hidden">
                                        ...
                                        <div class="timeline-badge-wrap d-flex flex-column align-items-center">
                                            <span class="timeline-badge border-3 border border-primary flex-shrink-0 my-8">
                                            </span>
                                            <span class="timeline-badge-border d-block flex-shrink-0"></span>
                                        </div>
                                        <div class="timeline-desc fs-3 text-dark mt-n1 fw-semibold">
                                            Mendiskusikan detail pekerjaan
                                            <ul class="text-primary fw-normal">
                                                <li>Menyepakati detail pekerjaan dan biayanya.</li>
                                                <li>Mendefinisikan hasil kerja.</li>
                                                <li>Menetapkan tenggat waktu pelaksanaan tugas.</li>
                                            </ul>
                                        </div>
                                    </li>
                                    <!-- Timeline item 2 -->
                                    <li class="timeline-item d-flex position-relative overflow-hidden">
                                        ...
                                        <div class="timeline-desc fs-3 text-dark mt-n1 fw-semibold">
                                            Melakukan pembayaran dan mulai bekerja.
                                            <ul class="text-primary fw-normal">
                                                <li>Freelancer membuat penawaran</li>
                                                <li>Pembeli melakukan pembayaran</li>
                                                <li>Freelancer mulai bekerja</li>
                                            </ul>
                                        </div>
                                    </li>
                                    <!-- Timeline item 3 -->
                                    <li class="timeline-item d-flex position-relative overflow-hidden">
                                        ...
                                        <div class="timeline-desc fs-3 text-dark mt-n1 fw-semibold">
                                            Periksa dan setujui hasil pekerjaan.
                                            <ul class="text-primary fw-normal">
                                                <li>Hasil akhir diserahkan</li>
                                                <li>Pembeli melakukan pengecekan dan menyetujui pekerjaan</li>
                                                <li>Ajukan revisi sesuai kesepakatan</li>
                                            </ul>
                                        </div>
                                    </li>
                                </ul>
                                ...
                                <div class="alert alert-primary" role="alert">
                                    Jika Anda memiliki pertanyaan lebih lanjut atau kendala, jangan ragu untuk menghubungi customer service kami.
                                </div>
                                </p>
                            </div>
                        </div>
