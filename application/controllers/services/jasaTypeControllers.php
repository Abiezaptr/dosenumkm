<?php
class jasaTypeControllers extends CI_Controller {
    ...
    public function index() {
        $data['title'] = 'DOSEN UMKM | Manage Jasa Type';
        $data['services'] = $this->service_model->get_jasaType();
        $this->load->view('partials/admin/header', $data);
        $this->load->view('admin/serv/type_jasa', $data);
