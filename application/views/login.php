        ...
        <div class="login-section">
            <form action="<?= base_url('login') ?>" method="POST">
                <div class="login-logo">
                    <img src="<?= base_url('assets') ?>/img/logo.png" alt="logo-img">
                </div>
                <h1>Login</h1>
                ...
                <div class="or">Or</div>
                <br>
                <a href="<?= site_url('login/google_login') ?>" class="google-login">
                    <img src="<?= base_url('assets') ?>/goggle.png" width="20" alt="Google Icon"> Sign in with Google
                </a>
                <div class="social-login">
                    <p>Don't have account? <a href="<?=site_url('register') ?>">Sign Up</a></p>
                </div>
            </form>
        </div>
