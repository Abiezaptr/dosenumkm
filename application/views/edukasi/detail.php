...
<div class="breadcrumb-wrapper">
    ...
    <div class="container">
        <div class="page-heading text-left">
            <h3 class="mb-1 text-white">Web Development</h3>
            <p class="mb-1 text-white">Belajar Figma: Esensi Desain Antarmuka Pengguna - Desain UI/UX</p>
...
<section class="contact-section fix section-padding">
    <div class="container">
        <div class="row pt-8">
            <div class="col-lg-7 mb-6 mb-lg-">
                <div class="mb-8">
                    <h3 class="ml-4 mb-1">Deskripsi <span class="lowercase">pembelajaran</span></h3>
                    <p class="text-muted mb-4 mt-3 line-height-md">Ingin menjadi desainer UI/UX tetapi tidak tahu harus mulai dari mana? Kursus ini akan memungkinkan Anda untuk mengembangkan keterampilan desain antarmuka pengguna Anda dan Anda dapat menambahkan desainer UI ke CV Anda dan mulai mendapatkan klien untuk keterampilan Anda. Halo semuanya. Saya Arash dan saya seorang desainer UI/UX. Dalam kursus ini, saya akan membantu Anda belajar dan menguasai aplikasi Figma secara menyeluruh dari awal. Figma adalah alat yang inovatif dan brilian untuk desain Antarmuka Pengguna. Digunakan oleh semua orang mulai dari pengusaha dan startup hingga Apple, Airbnb, Facebook, dan lainnya.</p>
                </div>
                <br>

                <div class="mb-8 mt-4">
                    <h3 class="ml-4 mb-1">Persyaratan <span class="lowercase">pembelajaran</span></h3>
                    <p class="text-muted mb-4 mt-3 line-height-md">Ingin menjadi desainer UI/UX tetapi tidak tahu harus mulai dari mana? Kursus ini akan memungkinkan Anda untuk mengembangkan keterampilan desain antarmuka pengguna Anda dan Anda dapat menambahkan desainer UI ke CV Anda dan mulai mendapatkan klien untuk keterampilan Anda. Halo semuanya. Saya Arash dan saya seorang desainer UI/UX. Dalam kursus ini, saya akan membantu Anda belajar dan menguasai aplikasi Figma secara menyeluruh dari awal. Figma adalah alat yang inovatif dan brilian untuk desain Antarmuka Pengguna. Digunakan oleh semua orang mulai dari pengusaha dan startup hingga Apple, Airbnb, Facebook, dan lainnya.</p>
                </div>
            </div>
                        ...
                        <div id="accordionCurriculum">
                                ...
                                <div id="CurriculumcollapseTwo" class="collapse show" aria-labelledby="curriculumheadingTwo" data-parent="#accordionCurriculum">
                                    <div class="border-top px-5 py-4 min-height-70 d-md-flex align-items-center">
                                        ...
                                        <div class="d-flex align-items-center overflow-auto overflow-md-visible flex-shrink-all">
                                            ...
                                            <a onclick="openModal()" class="text-secondary">
                                                <!-- Icon -->
                                    ...
                                    <div id="videoModal" class="modal">
                                        <div class="modal-content">
                                            ...
                                            <iframe id="videoFrame" width="100%" height="315" src="" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                        </div>
                                    </div>
                                    ...
                                    <div class="border-top px-5 py-4 min-height-70 d-md-flex align-items-center">
                                        ...
                                        <div class="d-flex align-items-center overflow-auto overflow-md-visible flex-shrink-all">
                                            <button class="btn btn-sm btn-primary me-5 font-size-sm fw-normal py-1">30 min</button>
                            ...
                            <div class="border rounded shadow mb-6 overflow-hidden">
                                ...
                                <div id="CurriculumcollapseThree" class="collapse" aria-labelledby="curriculumheadingThree" data-parent="#accordionCurriculum">
                                    <div class="border-top px-5 py-4 min-height-70 d-md-flex align-items-center bg-gray-100 flex-column">
                                        <!-- Information Text -->
                                        <div class="alert alert-secondary" role="alert" style="width: 100%;">
                                            <i class="fas fa-info-circle"></i>&nbsp; Persentase pengerjaan soal
                                        </div>
                                        <!-- Progress Bar -->
                                        <div style="width: 100%; background-color: #f3f3f3; border-radius: 8px; overflow: hidden; margin-bottom: 20px; height: 20px;">
                                            <div class="bg-success" style="width: 15%; height: 100%; text-align: center; color: white; font-weight: medium; line-height: 20px;">
                                                15%
                                            </div>
                                        </div>
                                        <!-- Button -->
                                        <a href="javascript:void(0)" class="btn btn-light w-100 btn-sm">
                                            PENDING
                                        </a>
                                    </div>
                                </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-6 col-xl-3">
                        <div class="card hover-img overflow-hidden rounded-2 h-100 d-flex flex-column card-custom">
                            <div class="position-relative">
                                <a href="javascript:void(0)"><img src="<?= base_url('assets') ?>/porto.png" class="card-img-top rounded-0" alt="..."></a>
                            </div>
                            <div class="card-body card-body-custom d-flex flex-column">
                                <h6 class="fw-medium fs-12">Jasa Web Design / Desain Website</h6>
                                <p class="fs-18">Profesional</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="card hover-img overflow-hidden rounded-2 h-100 d-flex flex-column card-custom">
                            <div class="position-relative">
                                <a href="javascript:void(0)"><img src="<?= base_url('assets') ?>/porto2.jpg" class="card-img-top rounded-0" alt="..."></a>
                            </div>
                            <div class="card-body card-body-custom d-flex flex-column">
                                <h6 class="fw-medium fs-12">Jasa Pembuatan Aplikasi Mobile</h6>
                                <p class="fs-18">Profesional</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="card hover-img overflow-hidden rounded-2 h-100 d-flex flex-column card-custom">
                            <div class="position-relative">
                                <a href="javascript:void(0)"><img src="<?= base_url('assets') ?>/porto3.jpg" class="card-img-top rounded-0" alt="..."></a>
                            </div>
                            <div class="card-body card-body-custom d-flex flex-column">
                                <h6 class="fw-medium fs-12">Jasa Digital Marketing / Pemasaran</h6>
                                <p class="fs-18">Online Terbaik</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="card hover-img overflow-hidden rounded-2 h-100 d-flex flex-column card-custom">
                            ...
                            <div class="card-body card-body-custom d-flex flex-column">
                                <h6 class="fw-medium fs-12">Jasa UI/UX Design untuk Website</h6>
                                <p class="fs-18">Profesional</p>
                            </div>
                        </div>
                    </div>
