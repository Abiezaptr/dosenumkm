                                            ...
                                            <div class="tab-content border mt-2">
                                                <div class="tab-pane active p-3" id="navpill-111" role="tabpanel">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <p>
                                                                <i class="ti ti-info-octagon"></i>&nbsp; <b>Paket : Jasa Pembuatan Aplikasi</b>
                                                            </p>
                                                            <p>Mulai dari Rp. 200.000 - Menerima perbaikan error atau bug pada sistem</p>
                                                            <p><a href=""><b>Lihat Paket</b></a></p>
                                                            <hr>
                                                ...
                                                <div class="tab-pane p-3" id="navpill-222" role="tabpanel">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <p>
                                                                <i class="ti ti-info-octagon"></i>&nbsp; <b>Paket : Pembuatan aplikasi web skala menengah</b>
                                                            </p>
                                                            <p>Mulai dari Rp. 500.000 - Menerima pembuatan aplikasi web tingkat menengah</p>
                                                            <p><a href=""><b>Lihat Paket</b></a></p>
                                                            <hr>
                                                            <button class="btn btn-primary text-white w-100 mt-3"><i class="ti ti-brand-hipchat fs-4"></i>&nbsp; Chat and Nego </button>
                                                            <p class="text-center text-muted mt-2"><small>Anda belum akan dikenakan biaya</small></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane p-3" id="navpill-333" role="tabpanel">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <p>
                                                                <i class="ti ti-info-octagon"></i>&nbsp; <b>Paket : Pembuatan aplikasi skala besar</b>
                                                            </p>
                                                            <p>Mulai dari Rp. 2.500.000 - Menerima pembuatan aplikasi untuk kantor</p>
                                                            <p><a href=""><b>Lihat Paket</b></a></p>
                                                            <hr>
                                                            <button class="btn btn-primary text-white w-100 mt-3"><i class="ti ti-brand-hipchat fs-4"></i>&nbsp; Chat and Nego </button>
                                                            <p class="text-center text-muted mt-2"><small>Anda belum akan dikenakan biaya</small></p>
                        ...
                        <div class="tab-content pt-4" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-description" role="tabpanel" aria-labelledby="pills-description-tab" tabindex="0">
                                <h5 class="fs-5 mb-7 text-primary">
                                    <b>Jasa Pembuatan Aplikasi Web - Sistem Informasi Sederhana dan Advanced</b>
                                    <br>
                                    <span class="text-muted fs-3">Terjual 9 kali &nbsp;&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp; <i class="ti ti-star text-warning"></i>&nbsp;4,9 (3)</span>
                                </h5>
                                <p class="mb-7">
                                    Menerima berbagai macam permintaan aplikasi - bugfix, revisi, remake, reskin - project jangka panjang, bisa request pekerjaan jangka panjang sendiri maupun team.
                                </p>
                                <p class="mb-0">
                            ...
                            <div class="tab-pane fade" id="pills-portofolio" role="tabpanel" aria-labelledby="pills-portofolio-tab" tabindex="0">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <p>Layanan kegiatan bootcamp yang dapat anda nikmati.</p>
                                        <div class="row">
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="card hover-img overflow-hidden rounded-2 h-100 d-flex flex-column">
                                                    ...
                                                    <div class="card-body pt-3 p-4 d-flex flex-column">
                                                        <h6 class="fw-semibold fs-4"><b>Jasa Web Design</b></h6>
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="card hover-img overflow-hidden rounded-2 h-100 d-flex flex-column">
                                                    ...
                                                    <div class="card-body pt-3 p-4 d-flex flex-column">
                                                        <h6 class="fw-semibold fs-4"><b>Jasa Pembuatan Aplikasi Mobile</b></h6>
                                                        <div class="d-flex align-items-center justify-content-between mt-auto">
                                                            <h6 class="fw-semibold fs-3 mb-0">Profesional</h6>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="card hover-img overflow-hidden rounded-2 h-100 d-flex flex-column">
                                                    ...
                                                    <div class="card-body pt-3 p-4 d-flex flex-column">
                                                        <h6 class="fw-semibold fs-4"><b>Jasa UI/UX Design</b></h6>
                                                        <div class="d-flex align-items-center justify-content-between mt-auto">
                                                            <h6 class="fw-semibold fs-3 mb-0">Wireframe UI</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
