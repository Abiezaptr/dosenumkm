    ...
    <div class="breadcrumb-wrapper">
        ...
        <div class="container">
            <div class="page-heading text-left">
                <h3 class="mb-1 text-white">Belajar Figma: Esensi Desain Antarmuka Pengguna - Desain UI/UX</h3>
                <p class="mb-1 text-white">Aplikasi Master Figma untuk mendapatkan pekerjaan di Desain UI, Antarmuka Pengguna, desain Pengalaman Pengguna, Desain Web & desain UX.</p>

                <div class="row mt-4">
                    <div class="col-md-8">
                        <div style="background: #001f3f; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin-bottom: 20px; color: white;">
                            <div style="display: flex; align-items: center;">
                                <img src="<?= base_url('assets') ?>/ico.png" alt="Profile Image" width="60" style="border-radius: 50%; margin-right: 20px;">
                                <div>
                                    <p style="margin: 0;">Created by <strong>Alison Dawn</strong></p>
                                    <p style="margin: 0;">Categories: Design</p>
                                    <p style="margin: 0;">Review:
                        ...
                        <!-- New Section -->
                        <div style="background: #001f3f; padding: 20px; border-radius: 8px; color: white;">
                            <li class="list-group-item d-flex align-items-center py-3">
                                <div class="text-secondary d-flex icon-uxs">
                                    <!-- Icon -->
                                    <svg width="16" height="16" class="text-white" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h6 class="mb-0 ms-3 me-auto" style="color: white;">Duration</h6>
                                <span>43 weeks</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center py-3">
                                <div class="text-secondary d-flex icon-uxs">
                                ...
                                <h6 class="mb-0 ms-3 me-auto" style="color: white;">Lectures</h6>
                                <span>32</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center py-3">
                                <div class="text-secondary d-flex icon-uxs">
                                    <!-- Icon -->
                                    <svg width="20" height="20" class="text-white" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h6 class="mb-0 ms-3 me-auto" style="color: white;">Enrolled</h6>
                                <span>1982 students</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center py-3">
                                <div class="text-secondary d-flex icon-uxs">
                                    <!-- Icon -->
                                    <svg width="16" height="16" class="text-white" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h6 class="mb-0 ms-3 me-auto" style="color: white;">Language</h6>
                                <span>English</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center py-3">
                                <div class="text-secondary d-flex icon-uxs">
                                ...
                                <h6 class="mb-0 ms-3 me-auto" style="color: white;">Skill Level</h6>
                                <span>beginner</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center py-3">
                                <div class="text-secondary d-flex icon-uxs">
                                ...
                                <h6 class="mb-0 ms-3 me-auto" style="color: white;">Deadline</h6>
                                <span>06 April 2020</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center py-3">
                                <div class="text-secondary d-flex icon-uxs">
                                    <!-- Icon -->
                                    <svg width="20" height="20" class="text-white" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h6 class="mb-0 ms-3 me-auto" style="color: white;">Certificate</h6>
                                <span>Yes</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center py-4">
                                <a href="./course-single-v5.html" class="mx-auto text-teal fw-medium d-flex align-items-center mt-2">
                                    ...
                                    <span class="ms-3" style="color: white;">Share this course</span>
                                </a>
                            </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div style="position: relative; cursor: pointer;" onclick="openModal()">
                            <img id="thumbnail" src="<?= base_url('assets') ?>/23.jpg" alt="Shopee Logo" style="width: 100%; border-radius: 8px;">
                            <div id="play-icon" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
                                <i class="fas fa-play-circle" style="font-size: 60px; color: white; animation: pulse 2s infinite;"></i>
                            </div>
                        </div>

                        <!-- Pricing Section Start -->
                        <div style="background: #001f3f; padding: 20px; border-radius: 8px; color: white; margin-top: 20px;">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <div>
                                    <span style="font-size: 24px; font-weight: bold;">$89.99</span>
                                    <span style="text-decoration: line-through; color: #ccc; margin-left: 10px;">$339.99</span>
                                    <span style="background: #6c63ff; color: white; padding: 5px 10px; border-radius: 5px; margin-left: 10px;">91% Off</span>
                                    <p style="margin: 5px 0 0; font-size: 14px;"><i class="ti-timer"></i> 2 days left at this price!</p>
                                </div>
                            </div>
                            <div style="display: flex; justify-content: space-between; margin-top: 20px;">
                                <a href="#" style="background-color: #007bff; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; text-align: center; width: 48%;">BUY NOW</a>
                                <a href="#" style="background-color: #ffcc80; color: black; padding: 10px 20px; border-radius: 5px; text-decoration: none; text-align: center; width: 48%;">ENROLL</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row pt-8">
                ...
                <div class="col-lg-5">
                    <div class="d-block">
                        <div class="mb-8">
                            <h3 class="mb-3">Video Pembelajaran</h3>
                                ...
                                <div class="border rounded shadow mb-6 overflow-hidden">
                                    ...
                                    <div id="CurriculumcollapseThree" class="collapse" aria-labelledby="curriculumheadingThree" data-parent="#accordionCurriculum">
                                        ...
                                        <div class="border-top px-5 py-4 min-height-70 d-md-flex align-items-center">
                                            ...
                                            <div class="d-flex align-items-center overflow-auto overflow-md-visible flex-shrink-all">
                                                <div class="btn btn-sm btn-primary me-5 font-size-sm fw-normal py-2">30 min</div>
                                                <a href="#" class="text-secondary">
                                                    <!-- Icon -->
                                                    <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M15.625 7.34375H7.3423V4.13164C7.3423 2.715 8.53391 1.5625 9.99855 1.5625C11.4632 1.5625 12.6548 2.715 12.6548 4.13164V5.625H14.2173V4.13164C14.2173 1.85344 12.3248 0 9.99855 0C7.67234 0 5.7798 1.85344 5.7798 4.13164V7.34375H4.375C3.08266 7.34375 2.03125 8.39516 2.03125 9.6875V17.6562C2.03125 18.9486 3.08266 20 4.375 20H15.625C16.9173 20 17.9688 18.9486 17.9688 17.6562V9.6875C17.9688 8.39516 16.9173 7.34375 15.625 7.34375ZM16.4062 17.6562C16.4062 18.087 16.0558 18.4375 15.625 18.4375H4.375C3.94422 18.4375 3.59375 18.087 3.59375 17.6562V9.6875C3.59375 9.25672 3.94422 8.90625 4.375 8.90625H15.625C16.0558 8.90625 16.4062 9.25672 16.4062 9.6875V17.6562Z" fill="currentColor" />
